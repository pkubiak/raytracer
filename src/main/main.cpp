...
void renderCornellboxB(float scale, const char* filename) {
    ...
    scene->add(new Quad(Point(000.f,550.f,000.f)*scale, Vector(550.f,000.f,000.f)*scale, Vector(000.f,000.f,560.f)*scale, nullptr, mat)); //ceiling
    ...
    scene->add(new Quad(Point(550.f,000.f,000.f)*scale, Vector(000.f,000.f,560.f)*scale, Vector(000.f,550.f,000.f)*scale, nullptr, mat)); //left wall
